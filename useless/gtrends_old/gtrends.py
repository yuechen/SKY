...
def getGTData(search_query, filename=None, date="all", geo="all", scale="1", position="end"):
...
def getGoogleTrendData(search_query, filename=None, date="2010-10", geo="all", scale="1"):
    getGTData(search_query=search_query, filename=filename, date=date, geo=geo, scale=scale)
